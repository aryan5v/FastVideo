#!/bin/bash
# Export pre-quantized w4a16 DiT weights for the FastH3 DMD2 student.
# Run:  sbatch /mnt/nfs/vlm-aryan/fasth3-14b-2step-qad-20260829/exp.sbatch /mnt/nfs/vlm-aryan/fasth3-14b-2step-qad-20260829/export_lane_w4a16.sh
set -euo pipefail
