...
def _resolve_checkpoint() -> tuple[Path, Path]:
    ...
    raise FileNotFoundError(
        f"5B transformer is not staged under {root}. This internal arming gate never downloads artifacts; "
        "set FASTVIDEO_WAN22_5B_ROOT to a reviewed local checkout whose source revision and SHA256 are "
        "recorded in tests/local_tests/wan2_2_ti2v_5b/PORT_STATUS.md.")
