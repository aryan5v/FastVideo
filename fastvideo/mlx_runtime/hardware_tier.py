...
# Set once Track D Rung 3 real-weight parity is green on Metal.
# FullAttn Diffusers layout matches the dense MLX loader.
FIVE_B_MODEL_REPO: str | None = "FastVideo/FastWan2.2-TI2V-5B-FullAttn-Diffusers"
