...
def load_module_from_path(
    *,
    ...
    # component instead of requiring every active entry in a modular manifest
    # to have been downloaded.  Released H3 student snapshots intentionally
    # omit the unused Ref2VA ``transformer_ref`` component, and pruned
    # candidates preserve that partial-snapshot layout.
